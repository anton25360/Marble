document.querySelector('form').addEventListener('submit', function(event) {
    ...
    //badge content
    document.querySelector('.textTest').innerHTML = "<h1 style='background: linear-gradient(to right,"+ color1 +", "+ color2 +"); display:inline-block; background-clip:text; -webkit-background-clip: text; -webkit-text-fill-color:transparent; font-size:80px; margin:0; padding:30px 70px;'>"+text+"</h1>"
